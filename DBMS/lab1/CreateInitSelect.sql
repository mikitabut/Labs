...
--SELECT * FROM Players; SELECT * FROM Tournaments; SELECT * FROM TournamentPlayers; SELECT * FROM Games;
...
CREATE TABLE Tournaments (
    ...
    CONSTRAINT FK_Tournaments_TournamentSystems FOREIGN KEY (TournamentSystemId) REFERENCES TournamentSystems(Id)
);
...
CREATE TABLE Games (
    ...
    CONSTRAINT FK_Games_Debuts FOREIGN KEY (DebuteId) REFERENCES Debutes(Id),
